...
class EMACross extends Strategy {
    constructor() {
        ...
        this.wot = "ddwad";
        setTimeout(() => {
            this.openTrade("EURUSD", "1 MINUTE", TradeOp.BUY_STOP, 1.2, this.getCurrentPriceForTradeOp("EURUSD", TradeOp.SELL_LIMIT) + 0.001, this.getCurrentPriceForTradeOp("EURUSD", TradeOp.SELL_LIMIT), this.getCurrentPriceForTradeOp("EURUSD", TradeOp.SELL_LIMIT) + 0.002);
        }, 1000);
